...
const connectMQTT = () => {
    ...
    client.on("message", async (topic, message) => {
        ...
        console.log(`\n[${timestamp}] 📩 MQTT DATA RECEIVED - ${topic}`);
        ...
        try {
            ...
            if (device) {
                ...
                console.log(`✅ Device Status: Active (${deviceId})`);
            } else {
            ...
            if (topic.includes("/health")) {
                ...
                console.log(`📊 HEALTH: 🌡️${data.temp || data.temperature || 'N/A'}°C | ❤️${data.hr || data.heartRate || 'N/A'}BPM | 🌬️${data.resp || data.respiration || 'N/A'}RPM | 😰${data.stress || 'N/A'} | 💧${data.humidity || 'N/A'}% | 🌬️IAQ:${data.iaq || 'N/A'} | 🫧CO2:${data.eco2 || 'N/A'} | ☁️TVOC:${data.tvoc || 'N/A'}`);
                ...
                console.log(`✅ Saved to DB: ${deviceId}`);
